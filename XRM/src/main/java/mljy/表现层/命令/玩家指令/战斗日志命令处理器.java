...
public class 战斗日志命令处理器 extends 抽象命令处理器 {
    ...
    private static final String 战斗日志名称键 = "玩家指令.日志.战斗日志名称";
    ...
    @Inject
    public 战斗日志命令处理器(翻译服务 翻译服务, 关键词解析器 关键词解析器,
                              玩家服务 玩家服务, 数据服务 数据服务) {
        super(翻译服务, 关键词解析器);
        this.玩家服务 = 玩家服务;
        this.数据服务 = 数据服务;
